...
>
>   ![](
https://edu-1395430748.oss-cn-beijing.aliyuncs.com/images/imgs/0049.png)
>
> 
>
...
>
>   ![](
https://edu-1395430748.oss-cn-beijing.aliyuncs.com/images/imgs/0051.png)
>
...
>
>   ![](
https://edu-1395430748.oss-cn-beijing.aliyuncs.com/images/imgs/0031.jpg)
...
```java
// 最大长度(maxFrameLength)，长度字段偏移量(lengthFieldOffset)，长度占用字节(lengthFieldLength)，长度调整(lengthAdjustment)，剥离字节数(initialBytesToStrip)
注：长度调整(lengthAdjustment) 表示 以长度为基准，还有几个字节是内容  剥离字节数(initialBytesToStrip)表示从头剥离几个字节
...
![](
https://edu-1395430748.oss-cn-beijing.aliyuncs.com/images/imgs/0013.png)
